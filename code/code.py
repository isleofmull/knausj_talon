...
setting_new_class_formatter          = mod.setting('code_new_class_formatter', str)
...
class Actions:
    ...
    def code_new_class_formatter(name: str):
        """inserts properly formatted new class"""
        actions.insert(actions.user.formatted_text(name, settings.get("user.code_new_class_formatter")))
